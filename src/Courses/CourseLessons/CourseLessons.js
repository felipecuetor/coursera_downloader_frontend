...
class CourseLessons extends Component {
  ...
  moveLessonToNewPosition(lesson_id, newPosition){
    ...
    if(lesson_to_move_to_position!==null && lesson_in_new_pos!==null){
      if(lesson_to_move_to_position["list_position"] > lesson_in_new_pos["list_position"]){
        ...
        this.setLessonNext(lesson_in_new_pos["id"],lesson_to_move_to_position["id"]);
        this.setLessonNext(lesson_to_move_to_position["id"],lesson_in_new_pos["next_lesson_id"]);
        if(lesson_previous_to_move_to_position!==null) this.setLessonNext(lesson_previous_to_move_to_position["id"], lesson_to_move_to_position["next_lesson_id"]);
      }
    }
    this.updateInfo();
  ...
  setLessonNext(lesson_id, next_lesson_id){
    var url = "/development/set_next_lesson/?lesson_id="+lesson_id+"&next_lesson_id="+next_lesson_id
  ...
  getCourseLessons()
  {
    var url = "/development/course_lessons/?course_id="+this.props.course.id
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.open( "GET", url, false ); // false for synchronous request
    xmlHttp.send( null );
    //console.log(xmlHttp.responseText)
  ...
  getLessonTags(lesson_id){
    var url = "/development/lesson_tags/?lesson_id="+lesson_id
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.open( "GET", url, false ); // false for synchronous request
    xmlHttp.send( null );
    var data = JSON.parse(xmlHttp.responseText);
  ...
  deleteLessonTag(tag_id){
    var url = "/development/lesson_x_tag/"+tag_id+"/"
    var xmlHttp = new XMLHttpRequest();
  ...
  addLessonXTag(lesson_id){
    try{
      ...
      //console.log(params)
      var url = "/development/lesson_x_tag/"
      var path = "/development/lesson_x_tag/"
